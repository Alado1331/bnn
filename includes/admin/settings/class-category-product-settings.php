	...
	class RSCategoryField {
		...
		public static function rs_edit_admin_settings_for_category_page( $term, $taxonomy ) {
			...
			if ( 'yes' == get_option( 'rs_point_price_activated' ) && 'yes' == get_option( 'rs_enable_product_category_level_for_points_price' ) ) {
				...
				<td>
					<input type="text" name="rs_category_points_price" id="rs_category_points_price" value="<?php echo esc_html($pointprice) ; ?>" class="srp-show-if-point-price-enable-category srp-point-price-fixed"/>
					<p>
					<?php 
					esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
					?>
			...
			if ( 'yes'  == get_option( 'rs_product_purchase_activated' ) && 'yes' == get_option( 'rs_enable_product_category_level_for_product_purchase' ) ) {
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="rs_category_points" id="rs_category_points" value="<?php echo esc_html($rewardpoints) ; ?>" class="srp-show-if-enable-reward-on-category"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="rs_category_percent" id="rs_category_percent" value="<?php echo esc_html($rewardpercent) ; ?>" class="srp-show-if-enable-reward-on-category"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="number" name="rs_get_min_quantity" id="rs_get_min_quantity" value="<?php echo esc_html($min_qty) ; ?>" min="1" class="srp-show-if-enable-reward-on-category"/>
					</td>
				</tr>
				<?php
			}
			if ( 'yes' == get_option( 'rs_referral_activated' )  && 'yes' == get_option( 'rs_enable_product_category_level_for_referral_product_purchase' ) ) {
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="referral_rs_category_points" id="referral_rs_category_points" value="<?php echo esc_html($referralrewardpoints) ; ?>" class="srp-show-if-referral-enable-category srp-referral-fixed"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="referral_rs_category_percent" id="referral_rs_category_percent" value="<?php echo esc_html($referralrewardpercent) ; ?>" class="srp-show-if-referral-enable-category srp-referral-percent"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="referral_rs_category_points_get_refered" id="referral_rs_category_points_get_refered" value="<?php echo esc_html($referralrewardpoints_get_refer ); ?>" class="srp-show-if-referral-enable-category srp-getrefer-fixed"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="referral_rs_category_percent_get_refer" id="referral_rs_category_percent_get_refer" value="<?php echo esc_html($referralrewardpercent_get_refer) ; ?>" class="srp-show-if-referral-enable-category srp-getrefer-percent"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
			...
			<?php } if ( 'yes' == get_option( 'rs_social_reward_activated' ) && 'yes' == get_option( 'rs_enable_product_category_level_for_social_reward' ) ) { ?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_facebook_rs_category_points" id="social_facebook_rs_category_points" value="<?php echo esc_html($socialfacebookpoints) ; ?>" class="srp-show-if-social-reward-enable-category srp-facebook-like-fixed"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_facebook_rs_category_percent" id="social_facebook_rs_category_percent" value="<?php echo esc_html($socialfacebookpercent) ; ?>" class="srp-show-if-social-reward-enable-category srp-facebook-like-percent"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_facebook_share_rs_category_points" id="social_facebook_share_rs_category_points" value="<?php echo esc_html($socialfacebookpoints_share) ; ?>" class="srp-show-if-social-reward-enable-category srp-facebook-share-fixed"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_facebook_share_rs_category_percent" id="social_facebook_share_rs_category_percent" value="<?php echo esc_html($socialfacebookpercent_share) ; ?>" class="srp-show-if-social-reward-enable-category srp-facebook-share-percent"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_twitter_rs_category_points" id="social_twitter_rs_category_points" value="<?php echo esc_html($socialtwitterpoints) ; ?>" class="srp-show-if-social-reward-enable-category srp-twitter-tweet-fixed"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_twitter_rs_category_percent" id="social_twitter_rs_category_percent" value="<?php echo esc_html($socialtwitterpercent) ; ?>" class="srp-show-if-social-reward-enable-category srp-twitter-tweet-percent"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_twitter_follow_rs_category_points" id="social_twitter_follow_rs_category_points" value="<?php echo esc_html($socialtwitterpoints_follow) ; ?>" class="srp-show-if-social-reward-enable-category srp-twitter-follow-fixed"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_twitter_follow_rs_category_percent" id="social_twitter_follow_rs_category_percent" value="<?php echo esc_html($socialtwitterpercent_follow ); ?>" class="srp-show-if-social-reward-enable-category srp-twitter-follow-percent"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_google_rs_category_points" id="social_twitter_rs_category_points" value="<?php echo esc_html($socialgooglepoints ); ?>" class="srp-show-if-social-reward-enable-category srp-google-plus-fixed"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
				...
				<tr class="form-field">
					...
					<td>
						<input type="text" name="social_instagram_rs_category_percent" id="social_instagram_rs_category_percent" value="<?php echo esc_html($socialinstagrampercent) ; ?>" class="srp-show-if-social-reward-enable-category srp-instagram-percent"/>
						<p class="description">
						<?php 
						esc_html_e( 'When left empty, Product and Global Settings will be considered in the same order and Current Settings (Category Settings) will be ignored. When value greater than or equal to 0 is entered then Current Settings (Category Settings) will be considered and Product/Global Settings will be ignored' , 'rewardsystem' )
						?>
