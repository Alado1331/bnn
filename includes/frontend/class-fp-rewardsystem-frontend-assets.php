	...
	class RSFrontendAssets {
		...
		public static function total_points_in_cart() {
			...
			<tr class="srp-points-cart-wrapper">
				<th class="srp-points-caption-cart"><?php echo wp_kses_post(get_option('rs_total_earned_point_caption')); ?></th>
				<td class="srp-points-value-cart" data-title="<?php echo wp_kses_post(get_option('rs_total_earned_point_caption')); ?>"><?php echo wp_kses_post(custom_message_in_thankyou_page($Points, $CurrencyValue, 'rs_show_hide_equivalent_price_for_points_cart', 'rs_show_hide_custom_msg_for_points_cart', 'rs_custom_message_for_points_cart', $PaymentPlanPoints)); ?> </td>
			</tr>
			<?php
		}
		...
		public static function total_points_in_checkout() {
			...
			<tr class="srp-points-checkout-wrapper">
				<th class="srp-points-caption-checkout"><?php echo wp_kses_post(get_option('rs_total_earned_point_caption_checkout')); ?></th>
		...
		public static function total_points_in_order_detail( $order) {
			...
			<tfoot>
				<tr class="srp-points-thankyou-wrapper">
					<th class="srp-points-caption-thankyou"><?php echo wp_kses_post(do_shortcode(get_option('rs_total_earned_point_caption_thank_you'))); ?></th>
