...
jQuery( function ( $ ) {
    ...
    var RedeemingPointsModule = {
        init : function () {
            ...
            $( document ).on( 'click' , '#rs_enable_redeem_for_selected_products' , this.enable_redeem_for_selected_product ) ;
            $( document ).on( 'click' , '#rs_exclude_products_for_redeeming' , this.enable_exclude_products_for_redeeming ) ;
            $( document ).on( 'click' , '#rs_enable_redeem_for_selected_category' , this.enable_redeem_for_selected_category ) ;
            $( document ).on( 'click' , '#rs_exclude_category_for_redeeming' , this.enable_exclude_category_for_redeeming ) ;
        ...
        toggle_redeeming_based_on : function (e) {
            if ( '1' === $(e).val() ){
                ...
                RedeemingPointsModule.toggle_enable_redeem_for_selected_product('#rs_enable_redeem_for_selected_products') ;
                RedeemingPointsModule.toggle_enable_exclude_products_for_redeeming('#rs_exclude_products_for_redeeming') ;
                RedeemingPointsModule.toggle_enable_redeem_for_selected_category('#rs_enable_redeem_for_selected_category') ;
                RedeemingPointsModule.toggle_enable_exclude_category_for_redeeming('#rs_exclude_category_for_redeeming') ;
            }
        } ,
        ...
        enable_exclude_category_for_redeeming(e){
            e.preventDefault();
            RedeemingPointsModule.toggle_enable_exclude_category_for_redeeming(this);
        },

        toggle_enable_exclude_category_for_redeeming(e){
            if ( 'yes' === $(e).is( ':checked' ) ) {
                $( '#rs_exclude_category_to_enable_redeeming' ).parent().parent().show() ;
            } else {
                $( '#rs_exclude_category_to_enable_redeeming' ).parent().parent().hide() ;
            }
        },
        enable_redeem_for_selected_category(e){
            e.preventDefault();
            RedeemingPointsModule.toggle_enable_redeem_for_selected_category(this);
        },

        toggle_enable_redeem_for_selected_category(e){
            if ( 'yes' === $(e).is( ':checked' ) ) {
                $( '#rs_select_category_to_enable_redeeming' ).parent().parent().show() ;
            } else {
                $( '#rs_select_category_to_enable_redeeming' ).parent().parent().hide() ;
            }
        },
        enable_exclude_products_for_redeeming(e){
            e.preventDefault();
            RedeemingPointsModule.toggle_enable_exclude_products_for_redeeming(this);
        },

        toggle_enable_exclude_products_for_redeeming(e){
            if ( 'yes' === $(e).is( ':checked' ) ) {
                $( '#rs_exclude_products_to_enable_redeeming' ).parent().parent().show() ;
            } else {
                $( '#rs_exclude_products_to_enable_redeeming' ).parent().parent().hide() ;
            }
        },
        enable_redeem_for_selected_product(e){
            e.preventDefault();
            RedeemingPointsModule.toggle_enable_redeem_for_selected_product(this);
        },

        toggle_enable_redeem_for_selected_product(e){
            if ( 'yes' === $(e).is( ':checked' ) ) {
                $( '#rs_select_products_to_enable_redeeming' ).parent().parent().show() ;
            } else {
                $( '#rs_select_products_to_enable_redeeming' ).parent().parent().hide() ;
            }
        },
